...
def index():
   ...
   # mStory = [i for i in all_user_stories]
    ...
    return render_template('index.html', mStory=mStory, mActionStory=mActionStory, mFantasyStory=mFantasyStory, random=random)
...
def reader(post_id):
    ...
    return render_template('story_reader.html', mStory=mStory)
...
def create():
    ...
    if request.method == 'POST':
        ...
        if not copyright or copyright == 'Choose':
            ...
            story = Story(post_id=post_id, poster_fist_name=f_name, poster_last_name=l_name, poster_id=poster_id, title=title, 
    ...
    story_cat = ['Choose', 'Romance', 'Love', 'Tragedy', 'Action', 'Adventure', 'Fanfiction', 'Fantasy', 
                 ...
                 'Poetry', 'Random', 'Science Fiction', 'Short Story', 'Spiritual', 'WereWolf', 'Teen Fiction', 'Vampire']
    story_aud = ['Choose','Young Adult (13-18 years of age)', 'New Adult (18-25 years of age)', 'Adult (25+ years of age)']
